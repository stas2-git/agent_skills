...
- When a task touches agent design, skill design, ADK, capstone work, protocol choice, deployment, security, or agent self-improvement, first consult `skills-library/agent-skills/SKILL.md` as the router.
...
- For Excel/workbook work, first consult `skills-library/excel-skills/SKILL.md` as the router.
- For SQL work in an actuarial or insurance context, first consult `skills-library/sql-skills/SKILL.md` as the router.

## Automatic Self-Improvement Habits

- Before finishing substantial work, run a lightweight self-audit using the ideas in `skills-library/agent-skills/coding-agent-workflow/agent-self-audit/SKILL.md`: intent, verification, trajectory, context drift, security risk, and residual risk.
...
- After editing agent skills, run `python3 skills-library/agent-skills/scripts/validate_agent_skills.py`.
- After editing Excel skills, run `python3 skills-library/excel-skills/scripts/validate_excel_skills.py`.
- After editing SQL skills, run `python3 skills-library/sql-skills/scripts/validate_sql_skills.py`.
